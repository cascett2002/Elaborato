<?php
    ...
    $rs = mysqli_query($con, $sql) or die("Query fallita: ottenimento assistenze fallito");
    $row = mysqli_num_rows($rs);
    if ($row > 0) {
        echo "<form method='post' action='eliminaassistenza2.php'>";
        ...
        while ($row = mysqli_fetch_row($rs)) {
            ...
            print "<td><input type='checkbox' name='scelta[" . $i . "]' value=" . $row[0] . "></td></tr>";
            $i++;
        }
        echo "</table><br>";
